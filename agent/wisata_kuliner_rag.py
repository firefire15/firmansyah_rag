...
class WisataKulinerAgent():
    ...
    def augment_prompt(self, query_text, context_string):
        ...
        prompt_template = f'''
            Anda adalah asisten AI yang bertugas sebagai orang yang mempromosikan sentra kuliner di Kota Bandung.
            ...
            Tampilkan makanan atau kuliner yang halal saja, jangan tampilkan kuliner haram seperti olahan babi, anjing, kodok, dan minuman keras.
...
if __name__ == "__main__":
    waa = WisataKulinerAgent()
    query = "Bagaimana jika saya ingin makan bakso di bandung?"
