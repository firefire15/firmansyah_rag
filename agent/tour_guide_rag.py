...
class TourGuideAgent():
    ...
    def select_relevant_node(self, state_):
        ...
        for key, value in state_.items():
            ...
            for item in value:
                ...
                if (isinstance(item, HumanMessage)
                    and ("mohon maaf" not in item.content.lower() or "maaf" not in item.content.lower())):
        ...
        if len(final_answers) == 0:
             final_answers.append("maaf, saya tidak memiliki informasi dari yang ditanyakan")
    ...
    def execute(self, query):
        ...
        #builder.add_node("message",RunnableLambda(self.message_agent))
        ...
        #builder.add_node("router_lokasi")
        #builder.set_entry_point(START)
        builder.add_edge(START, "wisata_alam")
        #builder.add_edge("message", "wisata_alam")
