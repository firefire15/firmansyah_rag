...
class WisataPendidikanAgent():
    def __init__(self):
        self.collection_name = "wisata_pendidikan_collection"
    ...
    def augment_prompt(self, query_text, context_string):
        ...
        prompt_template = f'''
            Anda adalah asisten AI yang bertugas sebagai orang yang mempromosikan wisata pendidikan di Kota Bandung.
...
if __name__ == "__main__":
    waa = WisataPendidikanAgent()
    query = "dimanakah lokasi puspa iptek?"
